...
public class PaymentVO {
	...
	public String getDcart_qty() {
		return dcart_qty;
	}
	public void setDcart_qty(String dcart_qty) {
		this.dcart_qty = dcart_qty;
	}
	...
	public int getCoup_amount() {
		return coup_amount;
	}
	public void setCoup_amount(int coup_amount) {
